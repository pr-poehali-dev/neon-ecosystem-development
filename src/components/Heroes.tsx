  ...
  const heroes = [
    {
      ...
      years: "1998 — 2023",
      region: "Москва",
      description: "Любил семью, мечтал стать инженером. Навсегда в наших сердцах.",
    },
    {
      name: "Дмитрий Соколов",
      years: "1996 — 2022",
      region: "Краснодар",
      description: "Добрый, смелый, всегда первым приходил на помощь друзьям.",
    },
    {
      name: "Михаил Петров",
      years: "2000 — 2023",
      region: "Екатеринбург",
      description: "Спортсмен и музыкант. Мама ждала его каждый день.",
    },
    {
      name: "Сергей Волков",
      years: "1995 — 2022",
      region: "Новосибирск",
      description: "Заботливый сын и старший брат. Гордость всей семьи.",
    },
    {
      name: "Андрей Морозов",
      years: "1999 — 2023",
      region: "Казань",
      description: "Мечтал открыть своё дело. Жизнерадостный и отзывчивый.",
    },
    {
      name: "Николай Кузнецов",
      years: "1997 — 2022",
      region: "Ростов-на-Дону",
      description: "Любил рыбалку и природу. Самый родной человек для мамы.",
    },
  ];

  return (
    <section id="heroes" className="bg-[#0a0a0a] py-24 px-4">
      <div className="container mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-sentient text-white mb-6">
            Наши <i className="font-light">герои</i>
          </h2>
          <p className="font-mono text-sm text-foreground/50 max-w-md mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {heroes.map((hero) => (
            <div
              key={hero.name}
              className="group relative border border-white/10 rounded-2xl p-6 bg-white/[0.03] hover:bg-white/[0.07] transition-all duration-300 hover:border-white/20"
            >
              {/* Аватар-заглушка */}
